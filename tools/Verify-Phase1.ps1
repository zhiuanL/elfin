...
try {
    ...
    & $dotnetExe test DesktopPet.sln --no-build --no-restore --configuration $Configuration --logger 'trx;LogFilePrefix=phase-1' --results-directory "artifacts/TestResults/$Configuration"
