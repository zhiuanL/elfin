...
try {
    ...
    & $dotnetExe test DesktopPet.sln -c $Configuration --no-build --no-restore --logger 'trx;LogFilePrefix=phase-6' --results-directory "artifacts/TestResults/$Configuration"
